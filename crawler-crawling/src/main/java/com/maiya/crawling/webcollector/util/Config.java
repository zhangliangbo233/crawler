...
package com.maiya.crawling.webcollector.util;
...
public class Config {
    ...
    public static int MAX_REDIRECT=2;
     ...
     public static String DEFAULT_USER_AGENT_OTHER = "Mozilla/5.0 (Windows NT 6.1; WOW64; rv:47.0) Gecko/20100101 Firefox/47.0";
