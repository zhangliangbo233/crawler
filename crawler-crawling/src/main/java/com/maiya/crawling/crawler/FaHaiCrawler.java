 ...
 */
@Component
public class FaHaiCrawler extends BreadthCrawler {

    private static final Logger LOGGER = LoggerFactory.getLogger(FaHaiCrawler.class);
    ...
    public FaHaiCrawler() {
        super("fahai_crawler", false);
    }

    public FaHaiCrawler(String crawlPath, boolean autoParse, String cookie) {
    ...
    public String startCrawl(RestrictSite site, WebDriver driver, String idCard, String realName) throws Exception {
        LOGGER.info("开始抓取信息 FaHaiCrawler idCard {},realName {}",idCard,realName);

        try {
            StringBuilder keyWords = new StringBuilder();
            keyWords.append(realName).append(" ").append(idCard);
            String cookie = RestrictSiteCookie.concatCookie(driver);
            FaHaiCrawler crawler = new FaHaiCrawler("fahai_crawler_"+idCard, autoParse, cookie);
            ...
            File file = new File("fahai_crawler_"+idCard);
